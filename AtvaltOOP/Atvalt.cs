...
namespace AtvaltOOP
{
    public class Atvalt
    {
        ...
        public Atvalt(string szam) //Az átalakítandó decimális szám változója
        {
            ...
            if (isBinaris(szam)) binarisToDecímalis(szam); // Ha bináris, átalakítom decimálissá,egyébként...
            else if (isDecimal(szam)) decimalToBinarist(szam); //... ha deimalis,akkor átalakítom binárissá, egyébként...
